...
const getFormattedSidebarMessages = (docsLinks, intl) => {
  const { learnMoreOutlineUrl, learnMoreGradingUrl, learnMoreVisibilityUrl } =
    docsLinks
    ...
    },
    {
      ...
      descriptions: [
        ...
        intl.formatMessage(messages.section_4_descriptions_2, {
          hide: (
            <strong>
              {intl.formatMessage(messages.section_4_descriptions_2_hide)}
            </strong>
          )
        }),
        intl.formatMessage(messages.section_4_descriptions_3, {
          hide: (
            <strong>
              {intl.formatMessage(messages.section_4_descriptions_3_hide)}
            </strong>
          )
        })
      ],
